...
> It should look like https://bscscan.com/tx/0x151xxxxxxxxxxxxxxxxxxxxxxxx89f4484a554 (x are to hide the exact transaction ID for this guide).
...
> Copy/paste the URL of the browser to the field __Transaction detail__ of the ticket.
> It should look like https://cchain.explorer.avax.network/tx/0xd628a40xxxxxxxxxxxxxxxxxxxxxxxxxxx650881a228b4/token-transfers (x are to hide the exact transaction ID for this guide).
...
> Copy/paste the URL of the browser to the field __Transaction detail__ of the ticket.
> It should look like https://polygonscan.com/tx/0x5b17fxxxxxxxxxxxxxxxxxxxe1bf1e4d2d2cfa5081ffc749b8182eab7 (x are to hide the exact transaction ID for this guide).  
...
> Copy/paste the URL of the browser to the field __Transaction detail__ of the ticket.
> It should look like https://etherscan.io/tx/0xfb8xxxxxxxxxxxxxxxxxxxe1bf1e4d2d2cfa5081ffc749b8182eab7 (x are to hide the exact transaction ID for this guide).  
