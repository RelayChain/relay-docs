...
### Some FAQs
* [Cross chain fees](https://0.masternode.io/docs/zerobridge.md)
* [Trading tokens with other DEXes / sending stable coins from one chain to another](https://0.masternode.io/docs/faq/faq006.md)
* [How to cross chain](https://0.masternode.io/docs/faq/faq023.md)
* [Why are some of the tokens named "zXXX"](https://0.masternode.io/docs/faq/faq005.md)
* [No liquidity to swap "zXXX" tokens after a cross chain](https://0.masternode.io/docs/faq/faq026.md)
