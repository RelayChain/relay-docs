...
<img alt="Select liquidity pool" src={useBaseUrl('/img/sd001-008.png')} />  
...
<img alt="Select liquidity pool" src={useBaseUrl('/img/sd001-009.png')} />  

> Click on the transaction details ID (1) to open the transaction detail    


<img alt="Select liquidity pool" src={useBaseUrl('/img/sd001-010.png')} />  
